<form method="get" action="address-form.php">
    ...
    <label for="postal-postalcode" style="margin-right: 4px">Postcode *</label><label for="postal-city">Plaats *</label><br>
    <input type="text" name="postal-postalcode" required maxlength="6" size="4" style="margin-right: 8px"><input type="text" name="postal-city" required><br>
