...
<input type="email" name="postal-EmailAddress" required><br>
...
<input type="text" class="mb-1" name="postal-postalcode" required maxlength="7" size="4" style="margin-right: 8px" inputmode="numeric" pattern="[1-9][0-9]{3}\s?[a-zA-Z]{2}">
