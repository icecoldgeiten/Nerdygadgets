...
if ($CategoryID == "") {
    ...
    $Query = "
                ...
                (CASE WHEN (SIH.QuantityOnHand) >= ? THEN 'Ruime voorraad beschikbaar.' ELSE QuantityOnHand END) AS QuantityOnHand, 
                (SELECT ImagePath
...
?>
    <div class="row">
        <div class="col-md-4 col-xs-12">
            <button class="btn btn-dark mt-3 d-md-none" data-toggle="collapse" data-target="#SearchParameters"><i class="fas fa-filter"></i>Filteren</button>
            <div class="SearchParameters collapse d-sm-block" id="SearchParameters">
                ...
                foreach ($ReturnableResult as $row) {
                    ...
                    <a class="ListItem" href='view.php?id=<?php print $row['StockItemID']; ?>'>
                        <div id="ProductFrame">
                            ...
                            <p class="StockItemComments mb-0"><?php print $row["MarketingComments"]; ?></p>
